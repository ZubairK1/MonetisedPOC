...
| **Ownership**    | 1 000 HAPD minted to Hospital A and 1 000 HBTD to Hospital B but transferred to requestor wallet (illustrating token buying)| `check_balances.py` shows initial split                    |
